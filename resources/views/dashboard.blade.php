...
<div class="container mt-4">
    ...
    <div class="row">
        ...
        <div class="col-md-4 mb-3">
            <div class="card shadow-sm" style="border-left: 5px solid #16a34a;">
                <div class="card-body">
                    <h5 class="text-muted">Pemasukan</h5>
                    <h3 style="color:#16a34a;">Rp {{ number_format($income) }}</h3>
                </div>
            </div>
        </div>
        ...
        {{-- Expense --}}
        <div class="col-md-4 mb-3">
            <div class="card shadow-sm" style="border-left: 5px solid #dc2626;">
                <div class="card-body">
                    <h5 class="text-muted">Pengeluaran</h5>
                    <h3 style="color:#dc2626;">Rp {{ number_format($expense) }}</h3>
                </div>
            </div>
        </div>
        ...
        {{-- Balance --}}
        <div class="col-md-4 mb-3">
            <div class="card shadow-sm" style="border-left: 5px solid #059669;">
                <div class="card-body">
                    <h5 class="text-muted">Sisa Saldo</h5>
                    <h3 style="color:#059669;">Rp {{ number_format($balance) }}</h3>
                </div>
            </div>
        </div>
            ...
            <div class="card shadow-sm">
                <div class="card-body">
                    ...
                    <div class="progress mb-2" style="height:8px;">
                        <div class="progress-bar" role="progressbar" style="background:#16a34a;width: {{ $percent }}%;">
                        </div>
                    </div>
                ...
                <div class="modal-body">
                    <form id="addTransactionForm" action="/transactions" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-control" name="category_id" id="transactionCategory" required>
                                ...
                                <option value="{{ $c->id }}">{{ $c->name }}
                                    ({{ $c->group ? $c->group->name : 'No Group' }})</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" name="description" id="transactionDescription"
                                required></textarea>
                        </div>
                ...
                <div class="modal-body">
                    <form id="editBudgetForm">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="livingPercent" min="0" max="100"
                                value="{{ $currentPercentages['living'] }}" required>
                        </div>
                        <div class="mb-3">
                            <label for="playingPercent" class="form-label">Playing (%)</label>
                            <input type="number" class="form-control" id="playingPercent" min="0" max="100"
                                value="{{ $currentPercentages['playing'] }}" required>
                        </div>
                        <div class="mb-3">
                            <label for="savingPercent" class="form-label">Saving (%)</label>
                            <input type="number" class="form-control" id="savingPercent" min="0" max="100"
                                value="{{ $currentPercentages['saving'] }}" required>
                        </div>
